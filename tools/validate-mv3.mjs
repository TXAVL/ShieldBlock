/*******************************************************************************
    ...
    Home: https://github.com/TXAVL/ShieldBlock
*/
...
if ( manifest.name !== (experimentalMode ? experimentalName : '__MSG_extName__') ||
    manifest.short_name !== 'ShieldBlock' ) {
    reportError('manifest.json does not use the ShieldBlock product identity');
}
...
for ( const requiredPath of [
    ...
    await validateFileReference(requiredPath, 'Required ShieldBlock component');
}
