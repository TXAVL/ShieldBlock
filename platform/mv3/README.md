...
This is an independent fork. See the project [README](https://github.com/TXAVL/ShieldBlock#readme), [compatibility matrix](https://github.com/TXAVL/ShieldBlock/blob/main/docs/FEATURE-MATRIX.md) and [attribution notice](https://github.com/TXAVL/ShieldBlock/blob/main/NOTICE.md).
