...
> [!NOTE]
> 側載的擴充功能不會透過 Chrome 線上應用程式商店更新。請關注 [Releases](https://github.com/TXAVL/ShieldBlock/releases)，並在新版本發佈後替換未封裝的建置版本。只安裝來自本儲存庫的成品，並驗證隨附的 SHA-256 總和檢查碼。
...
安全問題應透過 [GitHub Security Advisories](https://github.com/TXAVL/ShieldBlock/security/advisories/new) 私下回報，而不是提交公開 issue。回報政策請參閱 [SECURITY.md](../SECURITY.md)。
...
- [提出功能建議或回報錯誤](https://github.com/TXAVL/ShieldBlock/issues/new/choose)
- [提交 Filter Store 項目](https://github.com/TXAVL/ShieldBlock/issues/new?template=filter_store_submission.yml)
