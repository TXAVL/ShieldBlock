...
The seven screenshots listed above use the **1.0.0 Chromium MV3** package validated for commit [`2316c69`](https://github.com/TXAVL/ShieldBlock/commit/2316c69cddaae3eb190bedb1bba798fe48f730e9). Release ZIP SHA-256:
