...
Fork giữ lịch sử, copyright, source header và license GPL-3.0-or-later của [uBlock Origin](https://github.com/gorhill/uBlock). Code cộng đồng phải tương thích GPL và không dùng identity, signing key hay release channel chính thức của upstream. uBlock Plus+ là dự án độc lập tại `TXAVL/ShieldBlock`, không phải sản phẩm được Raymond Hill bảo trợ.
