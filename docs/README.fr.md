...
Les problèmes de sécurité doivent être signalés en privé via les [avis de sécurité GitHub](https://github.com/TXAVL/ShieldBlock/security/advisories/new), et non dans une issue publique. Consultez [SECURITY.md](../SECURITY.md) pour connaître la politique de signalement.
...
- [Proposer une fonctionnalité ou signaler un bug](https://github.com/TXAVL/ShieldBlock/issues/new/choose)
- [Soumettre une entrée au Filter Store](https://github.com/TXAVL/ShieldBlock/issues/new?template=filter_store_submission.yml)
